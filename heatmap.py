...
def get_params():
    params = {
        'weight': '/CLADet/runs/train/exp_yolov8n-CLAD-LFTA-DOTA-v1.0/weights/best.pt', 
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/CLADett/dataset/DOTA-v.10/images/test', 'heatmap/yolov8n-CLAD-LFTA-DOTA-v1.0/10_HiResCAM111')
